...
export function getTrendingGiphy(){
	...
	const trendingURL = `https://api.giphy.com/v1/gifs/trending?api_key=${process.env.API_KEY}&limit=12&rating=g`
...
export function getSearchGiphy(query){
	...
	const searchURL = `https://api.giphy.com/v1/gifs/search?api_key=${process.env.API_KEY}&q=${query}&limit=15&offset=0&rating=g&lang=en`;
